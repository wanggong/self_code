...
extern void blocks_mamager_free_all(void);
#endif
...
{
	pr_err("wgz_inode destroy inode\n");
...
#ifdef FAT_USE_BLOCK_MANAGER_WGZ
extern void blocks_mamager_free_all(void);
extern struct rb_node *blocks_mamager_free_blocks(int block_start , int count);
#endif
/*
