...
#if 1	//wgz add
//				write_to_file_for_audio_2s((char *)(out-b.frameCount), b.frameCount*2
//				,4501+10*i,AUDIO_FORMAT_PCM_16_BIT);
#endif	

                t.hook(&t, outTemp, numFrames, state->resampleTemp, aux);
#if 1	//wgz add
				write_to_file_for_audio_2s((char *)outTemp
				, numFrames*t.mMixerChannelCount*audio_bytes_per_sample(t.mMixerInFormat)
				,4502+10*i,t.mMixerInFormat);
#endif	
...
#if 1	//wgz add
					write_to_file_for_audio_2s((char *)t.in
					, t.buffer.frameCount*t.channelCount*audio_bytes_per_sample(t.mFormat)
					,4503+10*i,t.mFormat);
#endif	
                    t.hook(&t, outTemp + outFrames * t.mMixerChannelCount, t.buffer.frameCount,
                            state->resampleTemp, aux);
#if 1	//wgz add
					write_to_file_for_audio_2s((char *)(outTemp + outFrames * t.mMixerChannelCount)
					, t.buffer.frameCount*t.mMixerChannelCount*audio_bytes_per_sample(t.mMixerInFormat)
					,4504+10*i,t.mMixerInFormat);
#endif	
...
#if 1	//wgz add
		write_to_file_for_audio_2s((char *)outTemp 
		, numFrames*t1.mMixerChannelCount*audio_bytes_per_sample(t1.mMixerInFormat)
		,4801+10*j,t1.mMixerInFormat);
#endif			
        convertMixerFormat(out, t1.mMixerFormat,
                outTemp, t1.mMixerInFormat, numFrames * t1.mMixerChannelCount);
#if 1	//wgz add
		write_to_file_for_audio_2s((char *)out 
		, numFrames*t1.mMixerChannelCount*audio_bytes_per_sample(t1.mMixerFormat)
		,4802+10*j,t1.mMixerFormat);
#endif	
...
#if 1	//wgz add
	    write_to_file_for_audio_2s((char *)in, b.frameCount*2,4001,AUDIO_FORMAT_PCM_16_BIT);
#endif		
...
#if 1	//wgz add
	    	write_to_file_for_audio_2s((char *)(fout-b.frameCount), b.frameCount*sizeof(float)
	    	,4002,AUDIO_FORMAT_PCM_FLOAT);
#endif	
            break;
