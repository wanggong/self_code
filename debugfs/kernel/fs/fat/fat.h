...
if not use this , undef FAT_USE_BLOCK_MANAGER_WGZ
open this macro , if no other big bugs
test data:drity_page >= 20M , sdcard:class4 , write 6 file simutaneously
close : speed less than 2M , 400K-3.5M
open : speed more than 2M , about 3M
**********************************************************************************/
#define FAT_USE_BLOCK_MANAGER_WGZ
/*
...
struct msdos_inode_info {
	...
	struct rb_node *blocks_mamager_node; 
#endif
